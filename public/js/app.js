...
var updateCart = function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    ...
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      ...
      timeout: 1000,
      progressBar: false,
      text: " ".concat(pizza.name, " added to cart")
    }).show();
  })["catch"](function (err) {
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'error',
...
_admin__WEBPACK_IMPORTED_MODULE_2___default()();
...
__webpack_require__(/*! /Users/sahilshimpi/Documents/node/pizzaTracking/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/sahilshimpi/Documents/node/pizzaTracking/resources/scss/app.scss */"./resources/scss/app.scss");
